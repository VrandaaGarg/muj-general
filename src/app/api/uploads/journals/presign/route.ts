...
import {
  createPresignedJournalCoverUploadKey,
...
export async function POST(request: Request) {
  ...
  try {
    const objectKey = createPresignedJournalCoverUploadKey(session.user.id, {
    ...
    console.error("Failed to create journal cover upload URL", error);
    return NextResponse.json(

...
export function ResearchThumbnail({
  ...
  return (
    ...
    >
      ...
      <motion.div
        className="absolute inset-0    border border-border/20 bg-white/20 shadow-sm"
        variants={{
      ...
      {/* Page 3 */}
      <motion.div
        className="absolute inset-0    border border-border/30 bg-white/50 shadow-sm"
        variants={{
          rest: { x: 0, y: 0, rotate: 0, opacity: 0 },
      ...
      {/* Page 2 */}
      <motion.div
        className="absolute inset-0    border border-border/40 bg-white/70 shadow-sm"
        variants={{
          rest: { x: 0, y: 0, rotate: 0, opacity: 0 },
      ...
      <motion.div
        className="absolute inset-0    border border-border/50 bg-white/90 shadow-sm"
        variants={{
          rest: { x: 0, y: 0, rotate: 0, opacity: 0 },
      ...
      {/* Main thumbnail card */}
      <motion.div
        className="relative z-10 overflow-hidden    border border-border/60 shadow-sm"
        variants={{
